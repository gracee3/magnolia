...
impl Default for VisualConfig {
    fn default() -> Self {
        ...
        planet_colors.insert(
            "sun".to_string(),
            Color::from_hex("#FFD700").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "moon".to_string(),
            Color::from_hex("#C0C0C0").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "mercury".to_string(),
            Color::from_hex("#8B7355").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "venus".to_string(),
            Color::from_hex("#FFC0CB").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "mars".to_string(),
            Color::from_hex("#DC143C").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "jupiter".to_string(),
            Color::from_hex("#FFA500").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "saturn".to_string(),
            Color::from_hex("#808080").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "uranus".to_string(),
            Color::from_hex("#87CEEB").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "neptune".to_string(),
            Color::from_hex("#4169E1").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "pluto".to_string(),
            Color::from_hex("#2F4F4F").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
            "chiron".to_string(),
            Color::from_hex("#8B7355").unwrap_or(Color::WHITE),
        ...
        planet_colors.insert(
            ...
            Color::from_hex("#00CED1").unwrap_or(Color::WHITE),
        );
        planet_colors.insert(
        ...
        aspect_colors.insert(
            "trine".to_string(),
            Color::from_hex("#228B22").unwrap_or(Color::WHITE),
        );
        aspect_colors.insert(
            "square".to_string(),
            Color::from_hex("#FF0000").unwrap_or(Color::WHITE),
        );
        aspect_colors.insert(
            "sextile".to_string(),
            Color::from_hex("#FFA500").unwrap_or(Color::WHITE),
