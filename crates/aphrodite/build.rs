...
fn main() {
    ...
    out.push_str("            }\n");
    out.push_str("            GlyphOp::L(x, y) => {\n");
    out.push_str("                if !open {\n");
    out.push_str("                    builder.begin(lpoint(x, y));\n");
    out.push_str("                    open = true;\n");
    out.push_str("                }\n");
    out.push_str("                builder.line_to(lpoint(x, y));\n");
    out.push_str("            }\n");
    out.push_str("            GlyphOp::Q(x1, y1, x, y) => {\n");
    out.push_str("                if !open {\n");
    out.push_str("                    builder.begin(lpoint(x, y));\n");
    out.push_str("                    open = true;\n");
    out.push_str("                }\n");
    out.push_str("                builder.quadratic_bezier_to(lpoint(x1, y1), lpoint(x, y));\n");
    out.push_str("            }\n");
